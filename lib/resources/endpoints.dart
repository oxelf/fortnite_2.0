...
class Endpoints {
  ...
  String get eventsService => "${EpicServices().eventService}/api/v1";
  String get creativServices =>
      "${EpicServices().creativService}/fortnite/api/game/v2/creative";
  String get invite => "${EpicServices().partyService}/party/api/v1/Fortnite";
  String get friends =>
  ...
  String get webCreative => "${EpicServices().webService}/creative";
  String get presence => "${EpicServices().presenceService}/presence/api/v1/_";
}
